...
namespace ccxc_backend.DataModels
{
    public class login_log
    {
        ...
        /// <summary>
        /// 登录状态（0-保留 1-登录成功 2-请求无效 3-用户名错误 4-密码错误 5-没有登录权限 6-二次验证成功 7-二次验证无Ticket 8-二次验证失败 9-发送密码重置邮件 10-重置密码）
        /// </summary>
        [DbColumn(ColumnDescription = "登录状态（0-保留 1-登录成功 2-请求无效 3-用户名错误 4-密码错误 5-没有登录权限 6-二次验证成功 7-二次验证无Ticket 8-二次验证失败 9-发送密码重置邮件 10-重置密码）")]
