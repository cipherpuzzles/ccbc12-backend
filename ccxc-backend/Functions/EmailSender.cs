...
<p>尊敬的用户：</p>
<p>&nbsp;</p>
<p>您收到此邮件是因为您在 CCBC 网站中尝试进行密码重置。本邮件将会引导您完成之后的步骤。</p>
<p>&nbsp;</p>
<p>如果不是您申请的密码重置，可能是其他人错误的填写了您的邮件地址，请忽略本邮件。</p>
<p>要继续密码重置，请<a href=""https://ccbc12.cipherpuzzles.com/resetpass?token={token}"" target=""_blank"">点击此链接</a>进入密码重置页，然后在密码重置页上输入您的新密码。</p>
<p>&nbsp;</p>
<p>如果您点击以上链接无效，请尝试将以下链接复制到您的浏览器并打开：</p>
<p>https://ccbc12.cipherpuzzles.com/resetpass?token={token}</p>
<p>&nbsp;</p>
<p>祝参赛愉快。</p>
